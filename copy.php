...
<div class="layui-container layui-anim layui-anim-upbit"><br>
      ...
      <fieldset class="layui-elem-field">
          ...
          <div class="layui-field-box">
            初次见面-多多指教<br>校园宝致力于体同学更好的使用学院后勤<br>校园宝须登陆校园网后才能访问（测试）<br>感谢来信提出建议~<br><a target="_blank" href="http://mail.qq.com/cgi-bin/qm_share?t=qm_mailme&email=YVdRVVdXUVFSWCEQEE8CDgw" style="text-decoration:none;"><img src="http://rescdn.qqmail.com/zh_CN/htmledition/images/function/qm_open/ico_mailme_01.png"/>主题：校园宝+你的主题</a> 
          </div>
      </fieldset>
      <fieldset class="layui-elem-field">
