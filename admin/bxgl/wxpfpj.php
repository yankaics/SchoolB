...
$sqlc="select count(sid) from sch_repair_re where s_repair='".$_SESSION['name']."' and s_jg='已处理' and s_score!=0";
$rsc=mysql_query($sqlc,$con);
if($rowc=mysql_fetch_row($rsc))
{
	$sqlc2="select sum(s_score) from sch_repair_re where s_repair='".$_SESSION['name']."' and s_jg='已处理' and s_score!=0";
...
<div class="top-index">
    ...
    <div class="top-dh">
        ...
        <a href="wxrw.php"><div class="dh-index">任务</div></a>
  </div>
</div>
<!--main-->
<center>
<div class="admin-main">
<h2><?=$_SESSION['name']?>的平均评分:
	<?
	if($c==0)
	echo "0";
	else
...
<?
$sqll="select * from sch_repair_re where s_repair='".$_SESSION['name']."' and s_jg='已处理' and s_score!=0";
