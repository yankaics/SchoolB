  	 ...
  	 <div class="layui-col-md4 layui-col-md-offset4">
     	...
     	<form class="layui-form layui-form-pane" name="form" onsubmit="return check()" method="post" action="">
          <div class="layui-form-item">
            <label class="layui-form-label">宿管员账号</label>
            <div class="layui-input-block">
              <input type="text" id="username" name="username" required  lay-verify="required" placeholder="请输入宿管员账号" autocomplete="off" class="layui-input">
            </div>
          </div>
          ...
          <div class="layui-form-item">
		    ...
		    <div class="layui-input-block">
		      <select name="lh" lay-verify="required">
...
var form = layui.form;
        ...
        if(isset($_POST['button']))
		{
			...
			{
			$sql="insert into sch_admin values('','".$_POST['username']."','".$_POST['userpass']."','".$_POST['name']."','".$_POST['userid']."','宿管员','".$_POST['lh']."','3')";
			...
			if($rs>0)
			{
                ...
                <script>
					$(document).ready(function(e) {
						layui.use('layer', function(){
						var layer = layui.layer;
						layer.confirm('注册成功！<br>姓名：<?=$_POST['name']?><br>账号：<?=$_POST['username']?><br>密码：<?=$_POST['userpass']?><br>楼号：<?=$_POST['lh']?><br>电话：<?=$_POST['userid']?>', {
						btn: ['确定'],
						title: false,
						btnAlign: 'c',
						closeBtn: 0
						},function(){
							location.href="sginsert.php";
							});
						});			
					});
