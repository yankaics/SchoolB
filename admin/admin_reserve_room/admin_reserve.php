  	...
  	<table width="100%" class="layui-table table" id="" lay-filter="reserve_table" lay-even>
  		<thead>
	  		<tr>
			    ...
			    <td lay-data="{field:'tuser', width:200}" align="center" class="">申请人</td>
		...
		<tbody>
			...
			?>
		  	<tr>
			    	<td align="center">
						<button class="layui-btn layui-btn-sm">同意</button>
						<button class="layui-btn layui-btn-danger layui-btn-sm">拒绝</button>
			    	</td>
